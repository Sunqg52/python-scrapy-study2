...
class Teacher(models.Model):
	...
	bad_count = model.IntegerField(default=0, verbose_name='差评数')
	subject = model.ForeignKey(to=Subject, on_delete=models.PROTECT, db_column='sno', verbose_name='所属学科')
